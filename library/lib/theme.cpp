...
Theme Theme::horizon()
{
    ...
    theme.colors[ThemeVariant_LIGHT].buttonPlainDisabledBackgroundColor = nvgRGB(201, 201, 209);
    theme.colors[ThemeVariant_LIGHT].buttonPlainEnabledTextColor        = nvgRGB(255, 255, 255);
    theme.colors[ThemeVariant_LIGHT].buttonPlainDisabledTextColor       = nvgRGB(220, 220, 228);
    ...
    theme.colors[ThemeVariant_DARK].buttonPlainDisabledTextColor       = nvgRGB(71, 75, 74);
